  ...
  return (
    <section style={{ background: "#B06533", color: "#fff", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "1000px", margin: "0 auto", padding: "clamp(10px,1.2vw,16px) clamp(16px,4vw,44px)", textAlign: "center" }}>
        ...
        <p data-reveal="" style={{ fontSize: "14px", lineHeight: "1.5", margin: "0 auto 0", color: "rgba(255,255,255,.92)", whiteSpace: "nowrap" }}>Praetorian embeds directly into your ownership team, from early feasibility through final commissioning.</p>
        <p data-reveal="" style={{ fontSize: "14px", lineHeight: "1.5", margin: "0 auto 12px", color: "rgba(255,255,255,.92)" }}>Let us talk about what that looks like for your project.</p>
