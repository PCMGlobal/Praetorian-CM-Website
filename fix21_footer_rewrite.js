  ...
  return (
    <footer style={{ background: "#012530", color: "#a9b6bb" }}>
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "clamp(8px,1vw,12px) clamp(16px,4vw,44px) 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr 1fr", gap: "clamp(20px,3vw,48px)", paddingBottom: "clamp(12px,1.5vw,20px)", alignItems: "start" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
              ...
              <a href="https://www.youtube.com/@PraetorianCM" target="_blank" rel="noopener noreferrer" className="pcml-flink" style={{ color: "#B06533", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", width: "36px", height: "36px", borderRadius: "50%", background: "#003E52", flexShrink: 0 }} aria-label="YouTube">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" fill="#003E52"/></svg>
              </a>
              <a href="https://x.com/PraetorianCMgmt" target="_blank" rel="noopener noreferrer" className="pcml-flink" style={{ color: "#B06533", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", width: "36px", height: "36px", borderRadius: "50%", background: "#003E52", flexShrink: 0 }} aria-label="X">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.253 5.622L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/></svg>
              </a>
              <a href="https://www.instagram.com/praetoriancm" target="_blank" rel="noopener noreferrer" className="pcml-flink" style={{ color: "#B06533", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", width: "36px", height: "36px", borderRadius: "50%", background: "#003E52", flexShrink: 0 }} aria-label="Instagram">
          ...
          <div>
            ...
            <a href="tel:7809890289" style={{ ...linkStyle, display: "block" }}>(780) 989-0289</a>
...
fs.writeFileSync('app/components/Footer.tsx', footer, 'utf8');
console.log('Footer.tsx rewritten cleanly.');
