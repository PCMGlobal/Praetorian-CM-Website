...
// ── COTE GOLD PAGE ──────────────────────────────────────────────────────────
const cotePage = `import type { Metadata } from "next";
...
// ── KIENA PASTE PAGE ────────────────────────────────────────────────────────
const kienaPage = `import type { Metadata } from "next";
import Link from "next/link";
import CTABanner from "@/app/components/CTABanner";
...
fs.mkdirSync('app/projects/cote', { recursive: true });
fs.mkdirSync('app/projects/kiena', { recursive: true });
fs.writeFileSync('app/projects/cote/page.tsx', cotePage, 'utf8');
fs.writeFileSync('app/projects/kiena/page.tsx', kienaPage, 'utf8');

// Copy photos to public/images/photos
fs.copyFileSync('/mnt/user-data/uploads/Cote.jpg', 'public/images/photos/pcml-project-cote.jpg');
fs.copyFileSync('/mnt/user-data/uploads/Kiena.jpg', 'public/images/photos/pcml-project-kiena.jpg');

console.log('Created: app/projects/cote/page.tsx');
console.log('Created: app/projects/kiena/page.tsx');
console.log('Copied: pcml-project-cote.jpg');
console.log('Copied: pcml-project-kiena.jpg');
console.log('Done.');
